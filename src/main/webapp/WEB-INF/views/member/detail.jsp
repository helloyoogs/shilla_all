...
<link href="https://fonts.googleapis.com/css2?family=Nanum+Myeongjo:wght@400;700;800&display=swap" rel="stylesheet">
	...
	<link rel="stylesheet" href="/shilla/resources/css/detail.css?after">
...
<!-- header 끝 -->
	<main>
		<section class="content_wrap1">
			...
			<form method="POST" action="/shilla/member/delete">
			<div class="log1">
				...
				<p><a href="/shilla/member/update?id=${id}">회원수정으로 돌아가기</a></p>
			</div>
		</section>	
	</form>
		<!-- content_wrap1 끝 -->
