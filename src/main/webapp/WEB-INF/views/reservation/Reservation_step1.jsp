...
<!-- 제이쿼리 라이브러리 외부CDN추가 -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			//date_in date_out이 null이거나 같으면 submit x 
		$(".btn-black").click(function(btn_black_func) {
				if ($.trim($(".input-group input").val()) == '') {
					alert("날짜를 입력해주세요.");
					return false;
				} else if ($(".date_in").val() == $(".date_out").val()) {
	...
	<link rel="stylesheet" href="/shilla/resources/css/reset.css">
	<link rel="stylesheet" href="/shilla/resources/css/header.css">
	<link rel="stylesheet" href="/shilla/resources/css/reserve.css?after">
	<link rel="stylesheet" href="/shilla/resources/css/date.css">
	<link rel="stylesheet" href="/shilla/resources/css/footer.css">
	...
	<main>
		<section class="content_wrap1">
			<div class="container daterange px-1 px-sm-5 mx-auto">
				<form autocomplete="off" method="GET" action="/shilla/reservation/date_check">
				<input type="hidden" name="mem_id" value="${id}" />
					<div class="flex-sm-row flex-column d-flex">
						<div class="col-sm-9 col-12 px-0 mb-2">
							<div class="input-group input-daterange">
								<input type="text" class="form-control date_in" name="date_in" value="${date_in }" placeholder="Arriving Date" readonly>
								<input type="text" class="form-control date_out" name="date_out" value="${date_out }" placeholder="Leaving Date" readonly>
			...
			<div class="room_select">
				...
				<c:forEach var="row" items="${data }">
					<li>
					<form method="post" action="/shilla/reservation/select_room">
...
<!--                            <input type="text" id="numberUpDown1" name="person" value=""> -->
							...
							<div class="select5">
								<input type="submit" value="" class="reservation_btn">
